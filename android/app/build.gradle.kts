...
// Cargar credenciales del keystore desde key.properties si existe
// (lo genera el workflow de GitHub Actions a partir de los Secrets)
...
android {
    ...
    buildTypes {
        release {
            // Si hay key.properties (CI con secrets) firma con la keystore persistente;
            // si no, usa el debug keystore (build local).
